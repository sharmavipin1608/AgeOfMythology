 ...
 * @author vipinsharma
 */
public class Nidhogg extends ABattleCard{

    public Nidhogg(String culture) {
        super(culture);
        fixedNumOfDiceRolls=7;
    }
    ...
    public int getNumberOfDiceRoll(ABattleCard enemy,int boardIndex, int roleInBattle) {
        ...
        if(enemy.getUnitSpecialisation() == Constants.GIANT_KILLER)
            additionalRolls = 4;
