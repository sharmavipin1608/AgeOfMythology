 ...
 * @author vipinsharma
 */
public class BuildingTiles_GodCard {
    ...
    private int numOfBuidingsAllowed;
    
    public BuildingTiles_GodCard(int numOfBuildings)
    {
        ...
        numOfBuidingsAllowed = numOfBuildings;
        refreshFrame();
    }
...
//        {
        ...
        //                            imagePanel1.setOpaque(false);
                                ...
                                numOfBuildings++;
                                System.out.println("Number of buildings : " + numOfBuildings);
                                continuePlay();
//                                buildingTilesWindow.repaint();
//                                buildingTilesWindow.revalidate();
                                //refreshFrame();
                            }
                            else
                            {
                                numOfBuildings++;
                                JOptionPane.showMessageDialog(new JFrame(), "Player doesn't have resources to place this tile in city area.");
                            }
                        }
...
//        }
    ...
    public void continuePlay()
    {
        ...
        else
        {
            ...
            System.out.println("Count : " + buildingTilesWindow.getComponentCount());
            for(ImagePanel imagePanel : buildingTilesList)
            {
                int index = imagePanel.getType();
                if(!boardPanel.checkForValidityOfBuildingByIndex(index))
                {
                    imagePanel.add(disablePanel());
                    imagePanel.repaint();
